...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='rsvp_status',
            field=models.CharField(default='waiting', choices=[('waiting', 'RSVP: Waiting for response'), ('yes', 'RSVP: Confirmed attendance'), ('no', 'RSVP: Rejected invitation')], verbose_name='RSVP status', max_length=50),
        ),
        migrations.AlterField(
            model_name='application',
            name='state',
            field=models.CharField(null=True, default='submitted', choices=[('submitted', 'Application submitted'), ('accepted', 'Application accepted'), ('rejected', 'Application rejected'), ('waitlisted', 'Application on waiting list')], verbose_name='State of the application', max_length=50),
        ),
        migrations.AlterField(
            model_name='email',
            name='recipients_group',
            field=models.CharField(help_text='Only people assigned to chosen group will receive this email.', choices=[('submitted', 'Application submitted'), ('accepted', 'Application accepted'), ('rejected', 'Application rejected'), ('waitlisted', 'Application on waiting list'), ('waiting', 'RSVP: Waiting for response'), ('yes', 'RSVP: Confirmed attendance'), ('no', 'RSVP: Rejected invitation')], verbose_name='Recipients', max_length=50),
        ),
        migrations.AlterField(
            model_name='email',
            name='text',
            field=models.TextField(help_text='You can use HTML syntax in this message. Preview on the right.', verbose_name='Content of the email'),
        ),
        migrations.AlterField(
            model_name='form',
        ...
        migrations.AlterField(
            model_name='question',
            name='question_type',
            field=models.CharField(choices=[('paragraph', 'Paragraph'), ('text', 'Long text'), ('choices', 'Choices'), ('email', 'Email')], verbose_name='Type of the question', max_length=50),
        ),
        migrations.AlterField(
            model_name='question',
            name='title',
        ...
        migrations.AlterField(
            model_name='score',
            name='comment',
            field=models.TextField(help_text='Any extra comments?', blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='score',
            name='score',
            field=models.FloatField(validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(1)], help_text='5 being the most positive, 1 being the most negative.', blank=True, null=True),
        ),
    ]
